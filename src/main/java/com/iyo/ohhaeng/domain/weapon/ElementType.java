...
public enum ElementType {
    ...
    EARTH("토(土)", new String[]{"흙덩이",    "석검(石劍)",   "암석검(巖石劍)", "대지검(大地劍)", "황제검(黃帝劍)", "대지의 심장(大地心)"}),
    METAL("금(金)", new String[]{"쇳조각",    "철검(鐵劍)",   "강철검(鋼鐵劍)", "금강검(金剛劍)", "백호검(白虎劍)", "하늘의 날(天刃)"}),
    WATER("수(水)", new String[]{"물방울",    "수검(水劍)",   "파도검(波濤劍)", "심해검(深海劍)", "현무검(玄武劍)", "용궁의 파도(龍宮波)"});

    private final String display;
    private final String[] weaponNames;

    ElementType(String display, String[] weaponNames) {
